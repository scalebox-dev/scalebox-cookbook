# Anthropic Claude Code in scalebox Sandbox (JavaScript)

This example shows how to run Anthropic's [Claude Code](https://github.com/anthropics/claude-code) in scalebox Sandbox.
...
**1. Set up scalebox_API_KEY environment variable in `.env` file.**
